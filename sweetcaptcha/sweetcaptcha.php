...
*/
define('SWEETCAPTCHA_APP_ID',   osc_get_preference('app_id', 'sweetcaptcha')); // your application id (change me)
define('SWEETCAPTCHA_KEY',      osc_get_preference('app_key', 'sweetcaptcha')); // your application key (change me)
define('SWEETCAPTCHA_SECRET',   osc_get_preference('app_secret', 'sweetcaptcha')); // your application secret (change me)
define('SWEETCAPTCHA_PUBLIC_URL', osc_ajax_hook_url('sweetcaptcha')); // public http url to this file
